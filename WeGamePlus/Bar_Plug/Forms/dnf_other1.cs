...
namespace WeGamePlus.Bar_Plug.Forms
{
    public class dnf_other1 : Form
    {
        ...
        private void dnf_other1_Load(object sender, EventArgs e)
        {
            ...
            this.pictureBox1.Image = UrlManage.SetImage(XmlHelper.GetPublicXmlAttributeValue("DNF3", "image", false), "png");
            this.pictureBox2.Image = UrlManage.SetImage(XmlHelper.GetPublicXmlAttributeValue("DNF3", "hoverimage", false), "png");
            base.Icon = Icon.FromHandle(((Bitmap) UrlManage.SetImage("icon", "ico")).GetHicon());
            char[] separator = new char[] { ',' };
            string[] strArray = XmlHelper.GetPublicXmlAttributeValue("DNF3", "size1", false).Split(separator);
            char[] chArray2 = new char[] { ',' };
            string[] strArray2 = XmlHelper.GetPublicXmlAttributeValue("DNF3", "location1", false).Split(chArray2);
        ...
        private void InitializeComponent()
        {
            ...
            this.pictureBox1.Size = new Size(0x7b, 80);
            ...
            this.pictureBox2.Size = new Size(0x24, 0x1c);
            ...
            this.AutoSize = true;
            base.ClientSize = new Size(0x7b, 80);
            base.Controls.Add(this.pictureBox2);
            base.Controls.Add(this.pictureBox1);
            base.FormBorderStyle = FormBorderStyle.None;
            base.Name = "dnf_other1";
            base.ShowIcon = false;
            base.ShowInTaskbar = false;
            base.StartPosition = FormStartPosition.CenterScreen;
            this.Text = "dnf_other1";
            base.Load += new EventHandler(this.dnf_other1_Load);
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            try
            {
                StatisticsHelp.Statistics(2, XmlHelper.GetPublicXmlAttributeValue("DNF3", "statistics", false), "");
