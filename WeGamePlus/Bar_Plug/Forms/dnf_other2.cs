...
namespace WeGamePlus.Bar_Plug.Forms
{
    public class dnf_other2 : Form
    {
        ...
        private void dnf_other2_Load(object sender, EventArgs e)
        {
            ...
            this.pictureBox1.Image = UrlManage.SetImage(XmlHelper.GetPublicXmlAttributeValue("DNF4", "image", false), "png");
            this.pictureBox2.Image = UrlManage.SetImage(XmlHelper.GetPublicXmlAttributeValue("DNF4", "hoverimage", false), "png");
            base.Icon = Icon.FromHandle(((Bitmap) UrlManage.SetImage("icon", "ico")).GetHicon());
            char[] separator = new char[] { ',' };
            string[] strArray = XmlHelper.GetPublicXmlAttributeValue("DNF4", "size1", false).Split(separator);
            char[] chArray2 = new char[] { ',' };
            string[] strArray2 = XmlHelper.GetPublicXmlAttributeValue("DNF4", "location1", false).Split(chArray2);
        ...
        private void InitializeComponent()
        {
            ...
            this.pictureBox1.Size = new Size(0x60, 0x3f);
            ...
            this.AutoSize = true;
            base.ClientSize = new Size(0x60, 0x3f);
            base.Controls.Add(this.pictureBox2);
            base.Controls.Add(this.pictureBox1);
            base.FormBorderStyle = FormBorderStyle.None;
            base.Name = "dnf_other2";
            base.ShowIcon = false;
            base.ShowInTaskbar = false;
            this.Text = "dnf_other2";
            base.Load += new EventHandler(this.dnf_other2_Load);
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            try
            {
                StatisticsHelp.Statistics(2, XmlHelper.GetPublicXmlAttributeValue("DNF4", "statistics", false), "");
