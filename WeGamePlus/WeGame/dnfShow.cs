...
namespace WeGamePlus.WeGame
{
    public class dnfShow : Form
    {
        ...
        private void dnfShow_Load(object sender, EventArgs e)
        {
            ...
            this.pictureBox2.Image = UrlManage.SetImage("dnfshow", "png");
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(dnfShow));
            ...
            this.Text = "每日推荐";
            base.Load += new EventHandler(this.dnfShow_Load);
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                StatisticsHelp.Statistics(2, "3000", "");
        ...
        {
            if ((Enumerable.Where(Process.GetProcessesByName("tgp_daemon"), Process.GetProcessesByName("tgp_daemon") == null ? null : (ProcessFunc.func != null ? ProcessFunc.func : (ProcessFunc.func = ele => ele.MainWindowTitle == "WeGame"))) == null ? null : Process.GetProcessesByName("tgp_daemon").Where(Process.GetProcessesByName("tgp_daemon") == null ? null : ((ProcessFunc.func != null) ? ProcessFunc.func : (ProcessFunc.func = ele => ele.MainWindowTitle == "WeGame"))).FirstOrDefault()) != null)
            {
                if (!this.isOpen)
                {
                    this.isOpen = true;
        ...
        {
            public static readonly dnfShow.ProcessFunc processFunc = new dnfShow.ProcessFunc();
