...
namespace WeGamePlus.WeGame
{
    public class dnf_wai : Form
    {
        ...
        private void dnf_wai_Load(object sender, EventArgs e)
        {
            ...
            this.pictureBox1.Image = UrlManage.SetImage(XmlHelper.GetPublicXmlAttributeValue("DNF1", "image", false), "png");
            this.pictureBox2.Image = UrlManage.SetImage(XmlHelper.GetPublicXmlAttributeValue("DNF1", "hoverimage", false), "png");
            base.Icon = Icon.FromHandle(((Bitmap) UrlManage.SetImage("icon", "ico")).GetHicon());
            char[] separator = new char[] { ',' };
            string[] strArray = XmlHelper.GetPublicXmlAttributeValue("DNF1", "size1", false).Split(separator);
            char[] chArray2 = new char[] { ',' };
            string[] strArray2 = XmlHelper.GetPublicXmlAttributeValue("DNF1", "location1", false).Split(chArray2);
        ...
        private void InitializeComponent()
        {
            ...
            this.pictureBox1.Size = new Size(150, 600);
            this.pictureBox1.SizeMode = PictureBoxSizeMode.StretchImage;
            this.pictureBox1.TabIndex = 1;
            this.pictureBox1.TabStop = false;
            this.pictureBox1.Click += new EventHandler(this.pictureBox1_Click);
            this.pictureBox2.Cursor = Cursors.Hand;
            this.pictureBox2.Location = new Point(0x6f, 0);
            ...
            base.ClientSize = new Size(150, 600);
            base.Controls.Add(this.pictureBox2);
            base.Controls.Add(this.pictureBox1);
            base.FormBorderStyle = FormBorderStyle.None;
            this.MaximumSize = new Size(150, 600);
            this.MinimumSize = new Size(150, 600);
            base.Name = "dnf_wai";
            base.ShowIcon = false;
            base.ShowInTaskbar = false;
            this.Text = "DNF宝藏";
            base.Load += new EventHandler(this.dnf_wai_Load);
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            try
            {
                StatisticsHelp.Statistics(2, XmlHelper.GetPublicXmlAttributeValue("DNF1", "statistics", false), "");
