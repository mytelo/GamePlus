...
namespace WeGamePlus.WeGame
{
    public class lolShow : Form
    {
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(lolShow));
            ...
            this.Text = "每日推荐";
            base.Load += new EventHandler(this.lolShow_Load);
    ...
    {
        public static readonly lolShow.ProcessFunc processFunc = new lolShow.ProcessFunc();
