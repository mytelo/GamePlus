...
namespace WeGamePlus.WeGame
{
    public class nzShow : Form
    {
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(nzShow));
            ...
            this.pictureBox3.TabIndex = 0x12;
           ...
           // base.Icon = (Icon) manager.GetObject("$this.Icon");
            ...
            this.Text = "每日推荐";
            base.Load += new EventHandler(this.nzShow_Load);
        ...
        private void nzShow_Load(object sender, EventArgs e)
        {
            this.clickUrl = XmlHelper.GetPublicXmlValue("url_nz", false);
            ...
            this.pictureBox2.Image = UrlManage.SetImage("nzshow", "png");
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                StatisticsHelp.Statistics(5, "4000", "");
        ...
        {
            public static readonly nzShow.ProcessFunc processFunc = new nzShow.ProcessFunc();
